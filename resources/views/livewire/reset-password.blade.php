                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors @error('form.password_confirmation') border-red-500 @enderror"
