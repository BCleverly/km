<div class="relative inline-block" x-data="{ 
    open: false,
    theme: '{{ $theme }}'
}" @click.outside="open = false" @theme-changed.window="theme = $event.detail.theme" x-init="
...
">
    ...
    <!-- Dropdown menu with TailwindPlus Elements styling -->
    <div 
        x-show="open" 
        x-cloak
    ...
    >
        <div class="py-1">
            <button 
                ...
                class="flex w-full items-center gap-3 px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:text-gray-900 focus:outline-hidden dark:text-gray-300 dark:focus:bg-white/5 dark:focus:text-white cursor-pointer"
            >
