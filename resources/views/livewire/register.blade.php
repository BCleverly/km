    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" wire:submit="register">
            <div class="space-y-4">
                ...
                <div>
                    <label for="hear_about" class="block text-sm font-medium text-gray-700 mb-2">
                        How did you hear about us?
                    </label>
                    <select 
                        id="hear_about" 
                    ...
                    >
                        ...
                        <option value="advertisement">Social media advertisement</option>
                        <option value="referral">Friend or family referral</option>
                        <option value="other">Other</option>
                    </select>
                    @error('form.hear_about')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-3">
                ...
                <x-authenticate-passkey>
                    <button 
                        type="button"
                        class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors cursor-pointer"
                    >
