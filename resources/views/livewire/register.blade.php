    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
                Choose your plan and get started with a 14-day free trial
            </p>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        @foreach($this->plans as $plan)
                            <label class="relative flex items-start p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-red-300 transition-colors {{ $form->subscription_plan == $plan->value ? 'border-red-500 bg-red-50' : '' }}">
                                <input 
                                    type="radio" 
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="text-right">
                                            @if($plan === \App\Enums\SubscriptionPlan::Free)
                                                <span class="text-lg font-bold text-green-600">Free Trial</span>
                                                <p class="text-xs text-gray-500">14 days</p>
                                            @else
                                                <span class="text-lg font-bold text-gray-900">{{ $plan->priceFormatted() }}</span>
                                ...
                                <div class="ml-3 flex-shrink-0">
                                    <div class="w-5 h-5 rounded-full border-2 {{ $form->subscription_plan == $plan->value ? 'border-red-500 bg-red-500' : 'border-gray-300' }} flex items-center justify-center">
                                        @if($form->subscription_plan == $plan->value)
            ...
            <div>
                ...
                >
                    <span wire:loading.remove wire:target="register">
                        @if($form->subscription_plan == \App\Enums\SubscriptionPlan::Free->value)
                            Start Free Trial →
                        @else
                            Continue to Payment →
                        @endif
