            ...
            <div class="space-y-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        Add tags to help categorize your outcome. These can be updated by moderators during review.
                    </p>
                    
                    @foreach($this->outcomeForm->getAvailableTags() as $typeKey => $typeData)
                        <div class="mb-4">
                            ...
                            @php
                                $selectedTags = $this->outcomeForm->getSelectedTags()[$typeKey] ?? [];
                            @endphp
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 mb-3">
                                    @foreach($typeData['tags'] as $tagId => $tagName)
                                        <label class="flex items-center space-x-2 cursor-pointer">
                                            <input
                                                type="checkbox"
                                                wire:model="outcomeForm.tags.{{ $typeKey }}"
                                                value="{{ $tagId }}"
