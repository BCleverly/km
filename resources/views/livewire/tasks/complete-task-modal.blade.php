                ...
                @if($assignedTask)
                    <div class="flex gap-3 p-6 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
                        <button type="button" 
                                ...
                                wire:target="completeTask,completionImage"
                                @class([
                                    'flex-1 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2',
                                    'bg-green-600 hover:bg-green-700' => !$isSubmitting,
                                    'bg-gray-400 cursor-not-allowed' => $isSubmitting
                                ])
                                @if($isSubmitting) disabled @endif>
                            <span wire:loading.remove wire:target="completeTask,completionImage">I Completed This Task</span>
                            ...
                            <span wire:loading wire:target="completionImage" class="flex items-center gap-2">
                                <svg class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                        ...
                        <button type="button" 
                                ...
                                wire:target="completeTask,completionImage"
                                @class([
                                    'flex-1 text-white font-medium py-3 px-6 rounded-lg transition-colors',
