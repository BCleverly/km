<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">
            Complete Task: {{ $assignedTask->task->title }}
        </h3>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <form wire:submit="completeTask" class="space-y-6">
                ...
                <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        @php
                            ...
                            if ($isLifetime) {
                                $title = 'Lifetime Feature: Show Off Your Completion';
                            } else {
                                $title = 'Premium Feature: Show Off Your Completion';
                            }
                        @endphp
                        <h4 class="text-sm font-medium text-purple-900 dark:text-purple-100">{{ $title }}</h4>
                    </div>
            ...
            <div class="flex gap-4">
                ...
                <button type="button" 
                        wire:click="$dispatch('task-failed')"
                        wire:loading.attr="disabled"
                        wire:target="completeTask"
