        ...
        <div class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-red-500 px-6 pb-4 dark:bg-red-900/30 dark:ring-1 dark:ring-white/10">
          ...
          <nav class="flex flex-1 flex-col">
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
              <li>
                <ul role="list" class="-mx-2 space-y-1">
                  <li>
                    ...
                    <a href="#" class="group flex gap-x-3 rounded-md bg-red-600 p-2 text-sm/6 font-semibold text-white dark:bg-red-800/20">
                  ...
                  <li>
                    <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-red-200 hover:bg-red-600 hover:text-white dark:text-red-200/80 dark:hover:bg-red-700/25">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0 text-red-200 group-hover:text-white dark:text-red-200/80">
              ...
              <li class="mt-auto">
                <a href="#" class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-red-200 hover:bg-red-600 hover:text-white dark:text-red-200/80 dark:hover:bg-red-700/25">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0 text-red-200 group-hover:text-white dark:text-red-200/80">
      ...
      <div class="flex items-center gap-x-4 lg:gap-x-6">
        ...
        <div class="relative" x-data="{ open: false }" @click.outside="open = false">
          <button class="relative flex items-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md p-1 transition-colors" @click="open = !open">
            ...
            <img src="{{ auth()->user()->gravatar_url }}" alt="{{ auth()->user()->display_name }}" class="size-8 rounded-full bg-gray-50 outline -outline-offset-1 outline-black/5 dark:bg-gray-800 dark:outline-white/10" />
